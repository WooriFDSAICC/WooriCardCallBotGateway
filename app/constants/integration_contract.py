...
# TTS 발화 제어(Gateway 결정 → Relay 가 TTS Worker 로 라우팅). FDS 파이프라인 비대상.
EVENT_TTS_SAY = "TTS_SAY"
EVENT_TTS_STOP = "TTS_STOP"

TRITON_MODEL_STT = "stt_streaming"
TRITON_MODEL_ASD = "asd_voiceprint"
TRITON_MODEL_FDS = "fds_lgbm"
TRITON_MODEL_TTS = "tts_streaming"
